    ...
    <>
      ...
      <div className=' bg-purple-100 h-screen w-full'>
          ...
          <div className=' grid grid-cols-3 grid-rows-6 h-full w-10/12 pl-28 '>
            <p className='border-2 border-solid h-96 mr-8 mt-4 row-span-6 col-span-2 p-4 font-medium text-lg text-black bg-white border-purple-200 shadow-purple-50 shadow-[10px_10px_1px_0px_rgba(0,0,0,0.1)] pr-12'>De blue belt heeft de basis onder de knie. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
